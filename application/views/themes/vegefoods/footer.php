  ...
  <div class="container">
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><span class="icon icon-map-marker">
                  <h100>Jl. Sidodadi Timur No.24</h100>
                </span><span class="text"><?php echo get_settings('store_address'); ?></span></li>
              <li><a href="#"><span class="icon icon-phone"><h100>089510764731</h100></span><span class="text"><?php echo get_settings('store_phone_number'); ?></span></a></li>
              <li><a href="#"><span class="icon icon-envelope"><h100>evtarizkikurniawan@outlook.com</h100></span><span class="text"><?php echo get_settings('store_email'); ?></span></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->RIZKI SHOES STORE
