...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg13.jpg'); ?>');">
  <div class="container">
...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
  <div class="container">
    <div class="row">
      <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/bg14.jpg'); ?>);">
      ...
      <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
        <div class="heading-section-bold mb-4 mt-md-5">
          <div class="ml-md-0">
            <h2 class="mb-4">Selamat Datang di RIZKI SHOES STORE</h2>
          </div>
        </div>
        <div class="pb-md-5">
          <p>Belanja sepatu dengan kualaitas terbaik</p>
          <p>Tentang Kami dan Produk Kami. Rizki store adalah distributor Sepatu murah berkualitas berbagai penjuru dunia , memiliki kualitas yang bagus dan menarik 
    ...
    <div class="row no-gutters ftco-services">
      ...
      <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
        <div class="media block-6 services mb-md-0 mb-4">
          ...
          <div class="media-body">
            <h3 class="heading">Kualitas nomor 1</h3>
            <span>aman nyaman terpercaya</span>
          </div>
        </div>
      </div>
