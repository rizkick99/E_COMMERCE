...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg10.jpg'); ?>');">
  <div class="container">
    ...
    <div class="row d-flex mb-5 contact-info">
      ...
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Alamat </span>Jl. Sidodadi Timur No.24 Semarang Jawa Tengah</p>
        </div>
      </div>
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>WA </span>089510764731</p>
        </div>
      </div>
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span></span>evtarizkikurniawan@outlook.com </p>
        </div>
      </div>
